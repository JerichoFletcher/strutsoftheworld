...
public class SOTWRecipeProvider extends RecipeProvider implements IConditionBuilder {
    protected SOTWRecipeProvider(HolderLookup.Provider registries, RecipeOutput out) {
    ...
    public static class Runner extends RecipeProvider.Runner {
        ...
        protected @NotNull RecipeProvider createRecipeProvider(HolderLookup.@NotNull Provider registries, @NotNull RecipeOutput out) {
            return new SOTWRecipeProvider(registries, out);
        }
